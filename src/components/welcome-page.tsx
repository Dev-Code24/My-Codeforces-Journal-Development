    ...
    <div className="flex justify-center items-center flex-col">
      <div className="w-[355px]">
        <div className="w-full h-[200px] mb-4">
          <a href="https://youtu.be/1vlqXxdEqFI" target="_blank" rel="noopener noreferrer">
        ...
        <p className="text-base px-1 text-center">
          ...
          <a href="https://youtu.be/1vlqXxdEqFI" target="_blank" rel="noopener noreferrer" className="underline uppercase">
            Video Help
          </a>
        </p>
        <p className="text-base px-1 text-center">
